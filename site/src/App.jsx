...
const OG_SALE_BULK_TIERS = Object.freeze([
  { count: 5, discount: 5 },
  { count: 10, discount: 10 },
  { count: 20, discount: 15 },
...
const ToadzFinal = () => {
  ...
  useEffect(() => {
    if (!showOgSaleModal || typeof document === 'undefined') return undefined;
        ...
        */}
        ...
        {vaultTab === 'og' && (
          <div>
            ...
            {showOgSaleModal && typeof document !== 'undefined' && createPortal(
              <>
              <style>{`
                .og-sale-modal, .og-sale-modal * {
              ...
              <div
                ...
                style={{
                  ...
                  justifyContent: 'center',
                  paddingTop: isOgSaleMobile ? 'calc(env(safe-area-inset-top, 0px) + 8px)' : 20,
                  paddingBottom: isOgSaleMobile ? 14 : 20,
              ...
              >
                <div
                  onClick={(e) => e.stopPropagation()}
                  className="og-sale-modal"
                  style={{
                    width: '100%',
                    maxWidth: 560,
                    height: isOgSaleMobile ? 'calc(100svh - 28px)' : 'min(86vh, 760px)',
                    maxHeight: isOgSaleMobile ? 'calc(100svh - 28px)' : 'min(86vh, 760px)',
                    background: '#0d0d12',
                    border: '1px solid rgba(168,85,247,0.25)',
                    borderRadius: 16,
                    padding: isOgSaleMobile ? 11 : 18,
                    display: 'flex',
                    flexDirection: 'column',
                    overflow: 'hidden',
                    color: '#f8fafc',
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, flexShrink: 0 }}>
                    <div style={{ fontSize: isOgSaleMobile ? 30 : 30, fontWeight: 900, lineHeight: 1, color: '#fff' }}>Buy OGs</div>
                    <button
                      onClick={() => setShowOgSaleModal(false)}
                      style={{
                        width: 28,
                  ...
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(250,204,21,0.16) 0%, rgba(250,204,21,0.04) 100%)',
                    flexShrink: 0
                  }}>
                    ...
                    <div style={{
                      display: isOgSaleMobile ? 'flex' : 'grid',
                      gridTemplateColumns: isOgSaleMobile ? undefined : 'repeat(5, minmax(0, 1fr))',
                      gap: 6,
                            ...
                            >
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                  ...
                                  <div>
                                    <div style={{ fontSize: isOgSaleMobile ? 15 : 18, fontWeight: 800, color: '#f8fafc' }}>{row.label}</div>
                                    <div style={{ fontSize: isOgSaleMobile ? 10 : 13, color: 'rgba(255,255,255,0.72)' }}>
                                      {row.inventory > 0 ? `${row.inventory} left` : 'Sold out'}
                                    </div>
                                  </div>
                                </div>
                                <div style={{ fontSize: isOgSaleMobile ? 15 : 18, fontWeight: 900, color: '#00ff88', whiteSpace: 'nowrap' }}>
                              ...
                              <div style={{ marginTop: 10, display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 10 }}>
                                <button
                                  ...
                                  style={{
                                    width: isOgSaleMobile ? 34 : 42,
                                    height: isOgSaleMobile ? 34 : 42,
                                    borderRadius: 12,
                  ...
                  <div style={{
                    ...
                    paddingLeft: 12,
                    paddingRight: 12,
                    paddingBottom: isOgSaleMobile ? 'calc(16px + env(safe-area-inset-bottom, 0px))' : 12,
                    background: 'rgba(0,0,0,0.25)',
                    flexShrink: 0
                  }}>
                    ...
                    <div style={{ display: 'grid', gap: 6, marginBottom: 8 }}>
                      ...
                      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', marginTop: 2, paddingTop: 6, display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                        <span style={{ fontSize: 15, fontWeight: 800, color: 'rgba(255,255,255,0.92)' }}>TOTAL FLR owed</span>
                        <span style={{ fontSize: 21, fontWeight: 900, color: '#00ff88' }}>{ogSaleOwedDisplay} FLR</span>
                      </div>
                    </div>
                    {ogSaleQuote.error ? (
